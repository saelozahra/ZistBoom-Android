...
'				Dim RegistrationRole As String = institute.Get("RegistrationRole")
				Dim whatsapp As String = institute.Get("whatsapp")
				Dim instagram As String = institute.Get("instagram")
'				Dim aparat As String = institute.Get("aparat")
'				Dim bale As String = institute.Get("bale")
'				Dim telegram As String = institute.Get("telegram")
'				Dim igap As String = institute.Get("igap")
'				Dim eita As String = institute.Get("eita")
